	...
	var MP3Recorder = function(config) {
		...
		if (navigator.getUserMedia) {
			navigator.getUserMedia({
				...
				var context = new AudioContext(), microphone = context
						.createMediaStreamSource(stream), processor = context
						.createScriptProcessor(16384, 1, 1), // bufferSize大小，输入channel数，输出channel数
				...
				var realTimeWorker = new Worker('../../lib/mp3/worker-realtime.js');
